 ...
 * @author Jarek
 */
public class S3ScreenFadeTest extends S3App{
	...
	public void render(S3Gfx g){
		...
		if (S3.osTime > 1 && S3.osTime < 2 && ScreenManager.getScreen() != screenMain){
			ScreenManager.setScreen(screenMain, true);
		} else if (S3.osTime > 6 && S3.osTime < 7 && ScreenManager.getScreen() != screenAbout){
			ScreenManager.setScreen(screenAbout, true);
		}
