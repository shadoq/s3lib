 ...
 */
public class TextField extends com.badlogic.gdx.scenes.scene2d.ui.TextField implements GuiDefinition{
	...
	public TextField(String text, String messageText, Skin skin, String styleName){
	...
	public ArrayMap<String, String> getValues(){
		...
		values.put("messageText", getMessageText().toString());
	...
	public void setValues(String changeKey, ArrayMap<String, String> values){
		...
		setMessageText(values.get("messageText"));
