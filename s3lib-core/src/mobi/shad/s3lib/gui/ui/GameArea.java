 ...
 */
public class GameArea extends Actor implements GuiDefinition{
	...
	public void draw(Batch batch, float parentAlpha){
		if (showDebug){
			...
			batch.draw(S3Gfx.whiteTextureRegion, getX(), getY(), getOriginX(), getOriginY(), getWidth(), getHeight(), getScaleX(), getScaleY(), getRotation());
		}
	}
