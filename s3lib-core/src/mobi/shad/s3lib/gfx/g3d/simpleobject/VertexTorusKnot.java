 ...
 * @author Jarek
 */
public class VertexTorusKnot extends Object3d{
	 ...
	 * @return
	 */
	public static S3Mesh torusKnot(float radius, float tube, int radialSegments, int tubularSegments, float p, float q, float heightScale){
		...
		for (int i = 0; i < radialSegments; ++i){
			for (int j = 0; j < tubularSegments; ++j){
				...
				addTrilange(a, b, c, uva, uvb, uvc);
				addTrilange(a, c, d, uva, uvc, uvd);
