...
import mobi.shad.s3lib.gfx.pixmap.filter.Invert;
 ...
 * @author Jarek
 */
public class FxInvert extends Node{
	 ...
	 */
	public FxInvert(GuiForm effectData, ChangeListener changeListener){
		super("FxInvert_" + countId, Type.TEXTURE, effectData, changeListener);
		initData();
		initForm();
	}
