 ...
 * @author Jarek
 */
public class FxPixmapToTextureSprite extends Node{
	...
	public FxPixmapToTextureSprite(){
		this(null, null);
	}
	 ...
	 */
	public FxPixmapToTextureSprite(GuiForm effectData, ChangeListener changeListener){
