...
public class Julia implements ProceduralInterface{
	 ...
	 * @param maxIterations
	 */
	public static void generate(final Pixmap pixmap, double xCenter, double yCenter, double xSize, double ySize, double xIterations, double yIterations,
								int maxIterations){
	...
	public void random(final Pixmap pixmap){
		generate(pixmap, -0.5f + Math.random() * 1, -0.5f + Math.random() * 1, 1.0f + Math.random() * 1, 1.0f + Math.random() * 1, -0.5f + Math.random() * 1,
				 -0.5f + Math.random() * 1, 64);
	}
}
