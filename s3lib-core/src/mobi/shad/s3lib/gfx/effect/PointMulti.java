 ...
 * @author Jarek
 */
public class PointMulti extends AbstractEffect{
	...
	private float step2 = 1;
	private float step3 = 1;
	 ...
	 * @param random
	 */
	public PointMulti(boolean random){
		this();
	}
	...
	public final void init(){
		spriteCoords = new float[countSteps * count * 2 + 2];
	}
	...
	public void setValues(String changeKey, ArrayMap<String, String> values){
		...
		if (changeKey.equals("count") || changeKey.equals("countSteps")){
			init();
		}
	}
